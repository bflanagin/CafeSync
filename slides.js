...
function aboutslides(qsTr){
    ...
    slidelist.append({
                                 ...
                                 ftitle:qsTr("Card Creator"),
                                 disc:qsTr("To setup your card tap the card image at the top of the Setup page. It will take you to the card creator pictured above. If you would like to use your own card hit the use your own button. It costs 1USD per card image."),
    ...
    slidelist.append ({
                          ftitle:qsTr("Cards"),
                          disc:qsTr("Each user on the network has two cards to share. Because of the way that CafeSync works these cards can be about you, a cause you believe in, or a company. Think of each card as a way to both help yourself, and someone else."),
                          pic:"img/overlay-dark.png",
                          slidnum:6
    ...
    slidelist.append ({
                          ftitle:qsTr("Areas"),
                          disc:qsTr("The main view has three selectable card areas:PassersBy,Region,and Global. You can search, and save from any of these areas."),
                          pic:"img/overlay-dark.png",
                          slidnum:7
