            ...
            Column {
                ...
                Text {
                    ...
                    Text {
                        ...
                        font.pixelSize: thisWindow.width * 0.08
                        text: if (iswith != "") {
                                  qsTr(" ( with ") + currentcard_username.split(
                                              " ")[0] + ")"
                              } else {
                                  ""
                              }
                ...
                Row {
                    ...
                    SpinBox {
                        ...
                        from: 1
                        to: 12
                        value: if (d.getHours() > 12) {
                                   d.getHours() - 12
                               }

                        contentItem: Label {
                            text: if (parent.value < 10) {
                                      "0" + (parent.value)
                                  } else {
                                      parent.value
                                  }
                ...
                Item {
                    ...
                    ListView {
                        id: invitelistView
                        width: if (contentWidth < (thisWindow.width * 0.89)) {
                                   contentWidth
                               } else {
                                   thisWindow.width * 0.89
                               }
                        anchors.left: parent.left
                        ...
                        delegate: CirclePic {
                            ...
                            MouseArea {
                                anchors.fill: parent
                                onClicked: if (member.split(
                                                       ":")[0] !== usercardNum) {
                                               removeDialog.who = index
                ...
                Item {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            Events.save_event(
                                        Strings.replaceSpecials(eventName.text),
                                        Strings.replaceSpecials(eventLocation.text),
                                        Strings.replaceSpecials(about.text),
                                        party.toString(),
                                        selected_year, monthselect.value,
                                        theday, hour, miniuteSpin.value)
                        }
                        background: Rectangle {
                            color: highLightColor1
                        }
