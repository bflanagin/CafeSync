...
Item {
    ...
    Rectangle {
        ...
        anchors.centerIn:parent
        clip:true
        width:if(window_width > mobile_width) {parent.width * 0.60 } else {parent.width * 0.80}
        height:if(window_width > mobile_width) {parent.width * 0.60 } else {parent.width * 0.80}
    ...
    Rectangle {
        ...
        height:if(window_width > mobile_width) {parent.height * 0.20} else {parent.height * 0.10}
        color:Qt.rgba(0.1,0.1,0.1,0.8)
        radius:10
        border.width:1
        border.color:"white"
    ...
    Image {
        ...
        height:if(window_width > mobile_width) {parent.height * 0.95} else {parent.width * 0.2}
        width:if(window_width > mobile_width) {parent.height * 0.95} else {parent.width * 0.2}
    }
    ...
    Text {
        ...
        text:name
        font.pixelSize: if(window_width > mobile_width) {parent.height * 0.7 - name.length} else {parent.height * 0.4 - name.length}
        color:"white"
    }
