        ...
        if (http.readyState == 4) {
            ...
            if (http.responseText === '100') {
                ...
                if (pagedata.search("header-image") != -1) {
                    ...
                    banner = pagedata.substring(
                                pagedata.search(
                                    '<a href="/" class="header-image parallax cover " data-bg-image='),
                                pagedata.search(
                                    '<a href="/" class="header-image parallax cover " data-bg-image=') + 200).split(
                                '"')[5]
                } else {
                    banner = "../img/overlay-dark.png"
                }

                if (pagedata.search('class="blog-title"') != -1) {
                    name = pagedata.substring(
                                pagedata.search(
                ...
                if (pagedata.search('class="user-avatar"><img src="') != -1) {
                    ...
                    avatar = pagedata.split(
                                'property="og:image" content="')[1].split(
                                '" />')[0].trim()
                }
                if (pagedata.search('<span class="description">') != -1) {
                    message = pagedata.substring(
                                pagedata.search('<span class="description">'),
                                pagedata.search(
                                    '<span class="description">') + 200).split(
                                ">")[1].split("</")[0].trim()
                } else {
                    message = "<p>" + pagedata.split(
                                '<meta name="description" content="')[1].split(
                                '" />')[0] + "</p>"
                }
                var num = 1
                var posts
                ...
                while (posts.length > num && num <= 5) {
                    ...
                    if (postinfo.search('<div class="video-wrapper">') != -1) {
                        ...
                        tumblrposts.append({
                                               ...
                                               post: postinfo.substring(
                                                         postinfo.search(
                                                             "<p>") + 3,
                                                         postinfo.search(
                                                             "</p>"))
                                           })
                    } else if (postinfo.search(
                                   '<div class="post-content">') != -1) {
                        tumblrposts.append({
                                               posttitle: postinfo.substring(
                                                              postinfo.search(
                                                                  '<h2 class="title">'),
                                                              postinfo.search(
                                                                  '</h2>')).split(
                                   ...
                                   '<div class="photo-wrapper">') != -1) {
                        tumblrposts.append({
                                               posttitle: "",
                                               postimage//tmpostimage: postinfo.substring(postinfo.search('src="')+5,postinfo.search('" alt=')),
                                               : postinfo.split(
                                                     '<img src="')[1].split(
                                                   '" alt=')[0],
                                               post: postinfo.substring(
                                   ...
                                   '<div class="media_post photo_post">') != -1) {

                        if (postinfo.search("photoset") == -1) {
                            tumblrposts.append({
                                                   posttitle: "",
                                                   postimage: postinfo.split(
                                                                  '<img src="')[1].split(
                                                       '"')[0],
                                                   post: postinfo.split(
                                                             '<div class="credit">')[1].split(
                                                       '</div><!-- end .credit -->')[0]
                                               })
                        } else {
                            tumblrposts.append({
                                   ...
                                   '<div class="quote_post">') != -1) {

                        tumblrposts.append({
                                               posttitle: "Quote",
                                               postimage: "",
                                               post: postinfo.split(
                                                         '<div class="quote_post"><span>&ldquo;</span>')[1].split(
                                                   '</div>')[0] + "<br><br>" + postinfo.split(
                                                   '<div class="body">')[1].split(
                                                   '</div>')[0]
                                           })
                    } else {
