...
Item {
    ...
    property string pluginlogo: "../" + Scripts.socialsetup(
                                    service.split("::")[0]).split("::")[2]
        ...
        delegate: Item {
            ...
            Rectangle {
                ...
                Item {
                    ...
                    width: parent.width * 0.98
                    anchors.horizontalCenter: parent.horizontalCenter
                    height: titletext.height + postsplitter.height + postimg.height
                            + posttext.height + mainView.height * 0.06
                    Text {
                        id: titletext
                        width: parent.width
                        horizontalAlignment: Text.AlignHCenter
                        visible: if (theposttitle.length > 2) {
                                     true
                                 } else {
                                     false
                                 }
                    ...
                    Image {
                        visible: if (thepostimage.length > 2) {
                                     true
                                 } else {
                                     false
                                 }
