...
Item {
    ...
    Item {
        ...
        Item {
            ...
            anchors.verticalCenter: parent.verticalCenter
            visible: if (messagePage.area == "Conversations") {
                         true
                     } else {
                         false
                     }
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    messageContactsPage.state = "Active"
                }
    ...
    Item {
        ...
        Item {
            ...
            anchors.left: parent.left
            anchors.verticalCenter: parent.verticalCenter
            rotation: if (themenu.state == "Active") {
                          90
                      } else {
                          0
                      }
        ...
        Item {
            ...
            anchors.verticalCenter: parent.verticalCenter
            property int loc: if (listget == "temp") {
                                  0
                              } else {
                                  2
                              }
            ...
            Image {
                ...
                visible: false
                anchors.fill: parent
                source: if (selection != 1) {
                            switch (parent.loc) {
                            case 0:
                                "./icons/location.svg"
                                break
                            case 2:
                                "./icons/language-chooser.svg"
                                break
                            default:
                                "./icons/location.svg"
                                break
            ...
            MouseArea {
                ...
                onClicked: if (themenu.state != "Active") {
                               if (selection != 1) {
                                   switch (location_switch.loc) {
                                   case 0:
                                       currentcard = -1
                                       location_selected = "Region"
                                       cardslist.clear()
                                       listget = "region"
                                   ...
                                   if (swapopt.state == "InActive") {
                                       swapopt.type = "receive"
    ...
    Item {
        ...
        Item {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    if (settingsPage.sourceselect == true) {
                        settingsPage.sourceselect = false
                    } else {
    ...
    Item {
        ...
        Item {
            ...
            anchors.leftMargin: parent.width * 0.03
            rotation: if (catmenu.state == "Active") {
                          90
                      } else {
                          0
                      }
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: if (catmenu.state == "InActive") {
                               catmenu.state = "Active"
                           } else {
                               catmenu.state = "InActive"
                           }
            }
        }
        ...
        TextField {
            ...
            onTextChanged: {
                ...
                if (selection == 0) {
                    ...
                    Scripts.cards_Load(searchtextfield.text, listget)
                }
            }
        }
    ...
    Item {
        ...
        Item {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    if (achievePage.state == "Active") {
                        achievePage.state = "InActive"
                    } else if (swapopt.state == "Active") {
                        swapopt.state = "InActive"
                    } else {
        ...
        Item {
            ...
            MouseArea {
                ...
                onClicked: if (mainScreen.fromRequest == false) {
                               ...
                               switch (currentcard_saved) {
                               case 0:
                                   Scripts.delete_Card(currentcard_thecard,
                                                       listget)
                                   OpenSeed.remote_delete(userid, listget,
                                                          currentcard_thecard)
                                   cardslist.clear()
                                   Scripts.temp_Load(searchtext, listget)
                                   mainScreen.state = "InActive"
                               ...
                               case 1:
                                   Scripts.delete_Card(currentcard_thecard,
                                                       "saved")
                                   OpenSeed.remote_delete(userid, "saved",
                                                          currentcard_thecard)
                                   cardslist.clear()
                               ...
                               notification1.themessage = "Request Declined"
                           }
