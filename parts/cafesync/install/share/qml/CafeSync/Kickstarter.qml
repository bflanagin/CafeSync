...
Item {
    ...
    Rectangle {
        ...
        Text {
            ...
            width:parent.width
            font.pixelSize: if(window_width > mobile_width) {popup.height * 0.04} else {popup.width * 0.04}
            color:"white"
    ...
    Rectangle {
        ...
        Column  {
            ...
            width:if(window_width > mobile_width) {parent.width / 2} else {parent.width / 1.2}
            height:parent.height

           Text {
               text:backers
               font.pixelSize: if(window_width > mobile_width) {numbersgame.width * 0.1 - ammount.length}
                               else {numbersgame.width * 0.2 - ammount.length}
               color:"white"
               width:parent.width
           ...
           Text {
               ...
               color:"gray"
               font.pixelSize: if(window_width > mobile_width) {numbersgame.width * 0.05 - text.length}
                               else { numbersgame.width * 0.15 - ammount.length }
               width:parent.width
               horizontalAlignment: Text.AlignRight
           }
           ...
           Text {
               text:"of "+ammount
               font.pixelSize: if(window_width > mobile_width) {numbersgame.width * 0.05 - ammount.length}
                               else {numbersgame.width * 0.15 - ammount.length}
               color:"gray"
               width:parent.width
               horizontalAlignment: Text.AlignRight
    ...
    Image {
        ...
        states: [
                 ...
                 /*Text {
                     ...
                     anchors.horizontalCenter: parent.horizontalCenter
                     text:i18n.tr("Plugin Under Development")
                     ...
                     Text {
                         ...
                         width:parent.width
                         anchors.horizontalCenter: parent.horizontalCenter
                         text:i18n.tr("Tap to launch in external application")
                         wrapMode:Text.WordWrap
