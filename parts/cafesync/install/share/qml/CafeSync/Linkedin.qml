...
Item {
    ...
    GridView {
        ...
        delegate: Item {
                    ...
                    height:if(window_width > mobile_width) {articles.height * 0.80} else {articles.height * 0.50}
                    clip:true
        ...
        cellHeight: if(window_width > mobile_width) {height * 0.80} else {height * 0.50}
        cellWidth: width
