...
function upload_data(Id,name,phone,email,company,ali,motto,send,ua,sc,main,l1,l2,l3,l4,av,cardback,cardcat,cardsav,cardtem,cardsop) {
    ...
    */
    var url = "http://openseed.vagueentertainment.com/devs/" + devId + "/" + appId + "/scripts/addcardPOST.php";
    http.onreadystatechange = function() {
        if (http.readyState == 4) {
            //console.log(http.responseText);
...
function get_list(id,list) {
    ...
    switch(list) {
    case "saved":
        url = "http://openseed.vagueentertainment.com/devs/" + devId + "/" + appId + "/scripts/getlists.php?id=" + id+"&list="+list;
        carddata = "";
        //console.log(url);
        http.onreadystatechange = function() {
            if (http.readyState == 4) {
...
function remote_delete(id,list,cid) {
    ...
    switch(list) {
    case "saved":
        url = "http://openseed.vagueentertainment.com/devs/" + devId + "/" + appId + "/scripts/deleteref.php?id=" + id+"&list="+list+"&cid="+cid;
        carddata = "";
...
function website_snap(id,url,sitenum) {
    ...
    url = "http://openseed.vagueentertainment.com/devs/" + devId + "/" + appId + "/scripts/snaps.php?id="+id+"&url="+url+"&sitenum="+sitenum;
    //carddata = "";
    //console.log(url);
...
function onetime(id,action) {
    ...
    var url = "";
    if (action < 3) {
     url = "http://openseed.vagueentertainment.com/corescripts/onetime.php?devid=" + devId + "&appid=" + appId + "&cardid="+ id+"&create="+action;
    //carddata = "";
    //console.log(url);
...
function cardface_gen(name,company,id,email) {
    ...
    var http = new XMLHttpRequest();
    var url = "http://openseed.vagueentertainment.com/devs/" + devId + "/" + appId + "/scripts/cardface_gen.php";
    ...
    //http.send(null);
    http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    http.send("id="+ id + "&email=" + email+ "&name=" + name+ "&company=" + company);
